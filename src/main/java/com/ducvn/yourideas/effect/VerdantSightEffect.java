...
public class VerdantSightEffect extends Effect {
    protected VerdantSightEffect(EffectType p_i50391_1_, int p_i50391_2_) {
    ...
    public void applyEffectTick(LivingEntity entity, int amplifier) {
        if (entity instanceof PlayerEntity){
            ...
            if (!player.getPersistentData().getBoolean(YourIdeasMod.MODID + "verdant_sight")){
                ...
                player.getPersistentData().putBoolean(YourIdeasMod.MODID + "verdant_sight", true);
            }
            else {
