...
public class NegativeSightEffect extends Effect {
    protected NegativeSightEffect(EffectType p_i50391_1_, int p_i50391_2_) {
    ...
    public void applyEffectTick(LivingEntity entity, int amplifier) {
        if (entity instanceof PlayerEntity){
            ...
            if (!player.getPersistentData().getBoolean(YourIdeasMod.MODID + "negative_sight")){
                ...
                if (player.hasEffect(YourIdeasEffectsRegister.DIVISION_SIGHT.get())){
                ...
                player.getPersistentData().putBoolean(YourIdeasMod.MODID + "negative_sight", true);
            }
            else {
